defmodule UwsearchWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UwsearchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UwsearchWeb.Gettext, "errors", msg, opts)
    end
  end
